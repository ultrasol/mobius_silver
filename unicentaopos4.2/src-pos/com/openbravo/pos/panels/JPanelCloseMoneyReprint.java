...
//            m_jMaxDate.setText(m_PaymentsClosed.printDateEnd());
       ...
       try{
            ...
            if ("PostgreSQL".equals(sdbmanager)) {
                ...
                SQL = "SELECT * " +
                        "FROM draweropened " +
//                        "WHERE TICKETID = 'No Sale' AND OPENDATE > {fn TIMESTAMP('" + m_PaymentsClosed.getDateStartDerby() + "')}";
...
// Get Voids            
            ...
            if ("PostgreSQL".equals(sdbmanager)) {
                ...
                SQL = "SELECT * " +
                        "FROM lineremoved " +
//                        "WHERE TICKETID = 'Void' AND REMOVEDDATE > {fn TIMESTAMP('" + m_PaymentsClosed.getDateStartDerby() + "')}";
